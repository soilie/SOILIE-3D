    ...
    for baseline in ("layoutgpt","infinigen"):
        ...
        for left in grouped["soilie"]:
            ...
            for right in grouped[baseline]:
                ...
                if similarity < minimum_semantic_similarity or density_delta > MAX_DENSITY_DIFFERENCE:
                    continue
...
def freeze(rows, output, protocol_path, seed=SEED, limit=12, previous_protocols=(),
    ...
    document = {"schemaVersion":2,"studyVersion":"spatial-evidence-"+digest({"cases":cases,"seed":seed,"mode":evidence_mode,
                ...
                "sampling":{"seed":seed,"maximumPairsPerBaseline":limit,"withoutReplacementWithinBaseline":True,
                            ...
                            "matching":"maximum-cardinality one-to-one matching by room type, exact furniture and room-anchor counts, a frozen minimum normalized object-family agreement, and no more than 0.25 summed-footprint-density difference",
