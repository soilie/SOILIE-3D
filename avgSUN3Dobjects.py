...
''' VISUO 3D
    v.17.03.12
    A package for SOILIE 3D
    Written by Mike Cichonski
    for the Science of Imagination Laboratory
    Carleton University

    File: avgSUN3Dobjects.py
	This file processes all the csv files output by getSUN3Ddata.py and
	...
	to incomplete 3d data). Requires output from getSUN3Ddata.py.'''
